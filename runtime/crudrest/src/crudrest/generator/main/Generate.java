 ...
 *******************************************************************************/
package crudrest.generator.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/crudrest/generator/main/generate";
    ...
    */
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                String wpHome=	System.getenv("WP_HOME");
                if (wpHome!=null&&!wpHome.isBlank()) copyResource(args[1] ,wpHome+"\\wp-content\\plugins");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void registerPackages(ResourceSet resourceSet) {
    	resourceSet.getPackageRegistry().put(crudrestPackage.eNS_URI, crudrestPackage.eINSTANCE);
  		Resource.Factory.Registry  r = resourceSet.getResourceFactoryRegistry();
