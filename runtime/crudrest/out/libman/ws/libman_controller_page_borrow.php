<?php
 ...
 /**
 * Controller class for "borrow" Page REST webservice.
 *
 * @since      4.7.0
 * @package    libman
...
class libman_controller_page_borrow extends libman_controller {

  public function __construct() {
	parent::__construct('page_borrow','borrow','borrow',1);
  }
}
