<?php
 ...
 /**
 * Controller class for "publisher" REST webservice.
 *
 * @since      4.7.0
 * @package    libman
...
class libman_controller_publisher extends  libman_controller {

  public function __construct() {
	parent::__construct('publisher','publisher',null,1);
  }
