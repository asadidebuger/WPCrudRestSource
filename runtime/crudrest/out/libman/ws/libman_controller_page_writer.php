<?php
 ...
 /**
 * Controller class for "writer" Page REST webservice.
 *
 * @since      4.7.0
 * @package    libman
...
class libman_controller_page_writer extends libman_controller {

  public function __construct() {
	parent::__construct('page_writer','writer','writer',1);
  }
}
