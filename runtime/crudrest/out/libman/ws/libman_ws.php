...
require 'libman_controller_page_borrownotretuned.php';
...
class libman_ws{
 ...
 private $options_controller;
  ...
  public function __construct(){
	...
	$this->page_borrownotretuned=new libman_controller_page_borrownotretuned();
 ...
 */
  public function init_routes(){
	...
	$this->page_borrownotretuned->register_routes();
