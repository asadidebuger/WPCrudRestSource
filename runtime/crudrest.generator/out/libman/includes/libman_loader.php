...
//	  echo 'ewewewe'.add_menu_page;
	add_menu_page(__($page_title, 'crwp'), __( $menu_title, 'libman'), $capability, $menu_slug, $function,$icon_url,$position);
  }

  public function add_submenu_page($parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function = '', $position = null){
	add_submenu_page($parent_slug,__($page_title, 'libman'),__( $menu_title, 'libman'),$capability, $menu_slug, $function, $position);
  }
