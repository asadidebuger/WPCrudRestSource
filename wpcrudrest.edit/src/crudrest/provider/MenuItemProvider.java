...
/**
 * This is the item provider adapter for a {@link crudrest.Menu} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MenuItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Menu_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Menu_title_feature", "_UI_Menu_type"),
				 crudrestPackage.Literals.MENU__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addSlugPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Menu_slug_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Menu_slug_feature", "_UI_Menu_type"),
				 crudrestPackage.Literals.MENU__SLUG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 crudrestPackage.Literals.MENU__ICON,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(crudrestPackage.Literals.MENU__ITEMS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Menu.png"));
	}
	...
	public String getText(Object object) {
		String label = ((Menu)object).getTitle();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(crudrestPackage.Literals.MENU__ITEMS,
				 crudrestFactory.eINSTANCE.createMenuItem()));
	}
